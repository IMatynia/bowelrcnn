...
from .classification_models import make_classification_model_smaller
from .pattern_models import make_pattern_model_smaller
from .dataset_presets import random_dataset_7_2_1
from .dataset_roots import dataset_126x64


def get_smaller_spec_smaller_net_config():
    SEED = 42
    set_seeds(42)
    window = (64, 126)
    ...
    return RCNNModelConfig(
        seed=SEED,
        name="RCNN model with 126x64 spectrogram with smaller nets",
        version="1.0",
